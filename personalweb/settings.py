...
SECRET_KEY = '4i+_y!kf++3p_y-_a553%2k9^ckqto1%u-3pk9ee5v^^t^(v@!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Add your deployment provider's host here. E.g. '.herokuapp.com' for Heroku
ALLOWED_HOSTS = ['127.0.0.1']

# Uncomment below variables for production use
